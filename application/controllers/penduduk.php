...
class Penduduk extends CI_Controller{
	...
	function index($p=1,$o=0){
		...
		if(isset($_SESSION['iddesa'])){
			$data['iddesa'] = $_SESSION['iddesa'];
			$data['list_desa'] = $this->penduduk_model->list_desa($data['iddesa']);
		}
		*/
	...
	function form($p=1,$o=0,$id=''){
		...
		if($id){
			...
			if (isset($_SESSION['validation_error']) AND $_SESSION['validation_error']) {
				...
				if ($_SESSION['dari_internal']) {
					$data['penduduk'] = $_SESSION['post'];
					$data['des_sel'] = $_SESSION['post']['desa'];
		...
		$header = $this->header_model->get_data();
		$header['modul_ini'] = $this->modul_ini;
		$data['desa']  = $this->penduduk_model->list_desa();
		$data['dusun'] = $this->penduduk_model->list_dusun($data['des_sel']);
  ...
  function cetak_biodata($id=''){
	...
	function desa(){
		...
		if($iddesa!="")
			$_SESSION['iddesa']=$iddesa;
		else unset($_SESSION['iddesa']);
		redirect('penduduk');
	}
