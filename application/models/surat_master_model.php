<?php class surat_master_model extends CI_Model{
	...
	function upload($url=""){
		...
		$mime_type_rtf = array("application/rtf", "text/rtf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document");
		if(!in_array($tipe_file, $mime_type_rtf)){
			$_SESSION['error_msg'].= " -> Jenis file salah: " . $tipe_file;
			$_SESSION['success']=-1;
		} else {
			// Upload ke folder surat ubahan desa
			$vdir_upload = $folder_surat . $url . ".docx"; //abdulrohman ubah dari ".rtf" --> ".docx"
