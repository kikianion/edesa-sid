    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
      <table class="list">
          ...
          <tr>
            ...
            <th align="center" width="120">Alamat</th>
            <th align="center" width="100"><?php echo ucwords(config_item('sebutan_desa'))?></th>
          ...
          <?php  foreach($main as $data): ?>
            ...
            <td width="5"><div class="uibutton-group">
              ...
              <a href="<?php echo site_url("keluarga/edit_nokk/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data" target="ajax-modal" rel="window" modalWidth="auto" modalHeight="auto"header="Ubah Data KK"><span class="icon-edit icon-large"></span></a>
                ...
                <?php  if($grup==1 OR $grup==2){?><a href="<?php echo site_url("keluarga/delete/$p/$o/$data[id]")?>"  class="uibutton tipsy south"  title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span  class="icon-trash icon-large"></span> </a><?php  } ?>
        		</td>
