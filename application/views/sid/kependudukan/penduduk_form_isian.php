...
<tr>
  ...
  <td><input name="dokumen_kitas" type="number" class="inputbox" size="20"  value="<?php echo strtoupper($penduduk['dokumen_kitas'])?>"/></td>
</tr>
...
<tr>
  ...
  <td>
    <div class="uiradio">
      <input type="radio" id="sh11" name="miskin" value="0"/<?php if($penduduk['miskin'] == '0' OR $penduduk['miskin'] == ''){echo 'checked';}?>>
      <label for="sh11">Warga Mampu</label>
      <input type="radio" id="sh12" name="miskin" value="1"/<?php if($penduduk['miskin'] == '1' ){echo 'checked';}?>>
      <label for="sh12">Warga Miskin</label>
    </div>
  </td>
</tr>
<tr>
  <th>Status Bayar PBB</th>
  <td>
    <div class="uiradio">
      <input type="radio" id="sh13" name="bayar_pbb" value="0"/<?php if($penduduk['bayar_pbb'] == '0' OR $penduduk['bayar_pbb'] == ''){echo 'checked';}?>>
      <label for="sh13">Belum Lunas</label>
      <input type="radio" id="sh14" name="bayar_pbb" value="1"/<?php if($penduduk['bayar_pbb'] == '1' ){echo 'checked';}?>>
      <label for="sh14">Lunas</label>
    </div>
  </td>
</tr>
