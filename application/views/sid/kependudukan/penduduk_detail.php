        ...
        <div id="contentpane">
          <div class="ui-layout-center" id="maincontent" style="padding: 0px;">
            ...
            <table class="form" >
              ...
              <tr>
                <td>Desa</td><td >:</td>
                <td><?php echo strtoupper(ununderscore(unpenetration($penduduk['desa'])))?></td>
              </tr>
              <tr>
                <td>Dusun</td><td >:</td>
              ...
              <tr>
                <td>Status Ekonomi</td><td >:</td>
                <td><?php 
                
                $m = strtoupper($penduduk['miskin']);
                if($m == 0 || $m == ''){
                  echo 'Warga mampu';
                }elseif($m == 1){
                  echo 'Warga miskin';
              ...
              <tr>
                <td>Status Bayar PBB</td><td >:</td>
                <td><?php 
                
                $m = strtoupper($penduduk['bayar_pbb']);
                if($m == 0 || $m == ''){
                  echo 'Belum Lunas';
                }elseif($m == 1){
                  echo 'Lunas';
