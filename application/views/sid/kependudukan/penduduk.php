...
<input type="hidden" name="rt" value="">
    <div class="ui-layout-north panel">
        ...
        <div class="right">
            ...
            <div class="left">
                ...
                //abdulrohman
                ?>
                <select name="iddesa" onchange="formAction('mainform','<?php echo site_url('penduduk/desa')?>')">
                    <option value=""><?php echo ucwords(config_item('sebutan_desa'))?></option>
                    <?php foreach($list_desa AS $data){?>
                    <option value="<?php echo $data['iddesa']?>" <?php if($iddesa == $data['iddesa']) :?>selected<?php endif?>><?php echo ununderscore(unpenetration($data['iddesa']))?></option>
                    <?php }?>
                </select>
    ...
    <?php endif; ?>
		<tr>
            ...
            <th align="left" align="center"><?php echo ucwords(config_item('sebutan_desa'))?></th>
...
<td><?php echo strtoupper(unpenetration(ununderscore($data['desa'])))?></td>
