...
<div class="ui-layout-north" id="header">
	<div id="sid-logo"><a href="<?php echo site_url()?>" target="_blank">
                <img src="<?php echo LogoDesa($desa['logo']);?>" alt=""/></a></div>
...
<?php if($_SESSION['grup']==1){ ?>
	<li><a href="<?php echo site_url()?>man_user/form_login_as"><i class="icon-group icon-large"></i>Login Sebagai Admin Desa</a></li>

<?php }?>

<?php  if($_SESSION['grup']==1 OR $_SESSION['grup']==2){?>
	<li style="display:none" ><a  style="display:none" href="<?php echo site_url()?>modul/clear"><i class="icon-gear icon-large"></i>Pengaturan</a></li>
	...
	<li style="display:none" ><a  style="display:none" href="<?php echo site_url()?>statistik"><i class="icon-bar-chart icon-large"></i>Statistik</a></li>
	<li><a href="<?php echo site_url()?>surat"><i class="icon-print icon-large"></i>Cetak Surat</a></li>
	<li><a style="display:none" href="<?php echo site_url()?>analisis"><i class="icon-dashboard icon-large"></i>Analisis</a></li>
	<li style="display:none" ><a  style="display:none" href="<?php echo site_url()?>program_bantuan"><i class="icon-folder-open icon-large"></i>Program</a></li>
<?php  }?>
<?php  if($_SESSION['grup']==1 OR $_SESSION['grup']==2){?>
	<?php  if($_SESSION['grup']==1 OR $_SESSION['grup'==2]){?>
		<li><a href="<?php echo site_url()?>man_user/clear"><i class="icon-user icon-large"></i>Pengguna</a></li>
		<li  style="display:none" ><a  style="display:none" href="<?php echo site_url()?>database"><i class="icon-hdd icon-large"></i>Database</a></li>
	<?php  }?>
	<li style="display:none" ><a href="<?php echo site_url()?>sms"><i class="icon-envelope-alt icon-large"></i>SMS</a></li>
	<li  style="display:none"><a href="<?php echo site_url()?>web"><i class="icon-cloud icon-large"></i>Admin Web</a></li>
<?php  }?>
