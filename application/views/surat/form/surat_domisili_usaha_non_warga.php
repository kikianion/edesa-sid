					...
					<div class="right">
						<div class="uibutton-group">
							...
							<?php if (SuratCetak($url)) { ?>
								<button type="button"  style="display:none" onclick="$('#'+'main').attr('action','<?php echo $form_action?>');$('#'+'main').submit();" class="uibutton special"><span class="ui-icon ui-icon-print">&nbsp;</span>Cetak</button>
							<?php } ?>
