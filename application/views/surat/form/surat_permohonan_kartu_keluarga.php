				...
				<div class="ui-layout-south panel bottom">
					...
					<div class="right">
						<div class="uibutton-group">
							...
							<?php if (SuratCetak($url)) { ?><button type="button"  style="display:none" onclick="$('#'+'validasi').attr('action','<?php echo $form_action?>');$('#'+'validasi').submit();" class="uibutton special"><span class="ui-icon ui-icon-print">&nbsp;</span>Cetak</button><?php } ?>
