...
session_start();
if (isset($_SESSION['grup']) && $_SESSION['grup'] == 2) {
    //define("VERSION", '1.17');
    //define("LOKASI_LOGO_DESA", 'desa/'.$_SESSION['desa'].'/logo/');
    define("LOKASI_ARSIP", 'desa/' . $_SESSION['desa'] . '/arsip/');
    //define("LOKASI_CONFIG_DESA", 'desa/'.$_SESSION['desa'].'/config/');
    define("LOKASI_SURAT_DESA", 'desa/' . $_SESSION['desa'] . '/surat/');
    define("LOKASI_SURAT_FORM_DESA", 'desa/' . $_SESSION['desa'] . '/surat/form/');
    define("LOKASI_SURAT_PRINT_DESA", 'desa/' . $_SESSION['desa'] . '/surat/print/');
    define("LOKASI_SURAT_EXPORT_DESA", 'desa/' . $_SESSION['desa'] . '/surat/export/');
    define("LOKASI_USER_PICT", 'desa/' . $_SESSION['desa'] . '/upload/user_pict/');
    define("LOKASI_GALERI", 'desa/' . $_SESSION['desa'] . '/upload/galeri/');
    define("LOKASI_FOTO_ARTIKEL", 'desa/' . $_SESSION['desa'] . '/upload/artikel/');
    define("LOKASI_FOTO_LOKASI", 'desa/' . $_SESSION['desa'] . '/upload/gis/lokasi/');
    define("LOKASI_FOTO_AREA", 'desa/' . $_SESSION['desa'] . '/upload/gis/area/');
    define("LOKASI_FOTO_GARIS", 'desa/' . $_SESSION['desa'] . '/upload/gis/garis/');
    define("LOKASI_DOKUMEN", 'desa/' . $_SESSION['desa'] . '/upload/dokumen/');
    define("LOKASI_PENGESAHAN", 'desa/' . $_SESSION['desa'] . '/upload/pengesahan/');
    define("LOKASI_WIDGET", 'desa/' . $_SESSION['desa'] . '/widget/');


    if (isset($_SESSION['desa']) && !empty($_SESSION['desa'])) {
        mkdirdesa();
    }
}
...
if (!defined("LOKASI_LOGO_DESA")) {
    define("LOKASI_LOGO_DESA", 'desa/logo/');
}

if (!defined("LOKASI_ARSIP")) {
    define("LOKASI_ARSIP", 'desa/arsip/');
}

if (!defined("LOKASI_CONFIG_DESA")) {
    define("LOKASI_CONFIG_DESA", 'desa/config/');
}

if (!defined("LOKASI_SURAT_DESA")) {
    define("LOKASI_SURAT_DESA", 'desa/surat/');
}

if (!defined("LOKASI_SURAT_FORM_DESA")) {
    define("LOKASI_SURAT_FORM_DESA", 'desa/surat/form/');
}

if (!defined("LOKASI_SURAT_PRINT_DESA")) {
    define("LOKASI_SURAT_PRINT_DESA", 'desa/surat/print/');
}

if (!defined("LOKASI_SURAT_EXPORT_DESA")) {
...
//abdulrohman
// untuk membuat struktur folder desa masing-masing

function mkdirdesa() {
    //collecting data structure
    $folder[] = LOKASI_ARSIP;
    $folder[] = LOKASI_SURAT_DESA;
    $folder[] = LOKASI_SURAT_FORM_DESA;
    $folder[] = LOKASI_SURAT_PRINT_DESA;
    $folder[] = LOKASI_SURAT_EXPORT_DESA;
    $folder[] = LOKASI_USER_PICT;
    $folder[] = LOKASI_GALERI;
    $folder[] = LOKASI_FOTO_ARTIKEL;
    $folder[] = LOKASI_FOTO_LOKASI;
    $folder[] = LOKASI_FOTO_AREA;
    $folder[] = LOKASI_FOTO_GARIS;
    $folder[] = LOKASI_DOKUMEN;
    $folder[] = LOKASI_PENGESAHAN;
    $folder[] = LOKASI_WIDGET;
